...
contract HyFiHookUpdateQuotersTest is HyFiHookSharedSetup {
    ...
    function test_updateQuoters_changesQuoter() public {
        SimpleQuoter newQ = deployQuoterProxy(pm, address(hook), mm1, DEFAULT_BASE_FEE, DEFAULT_FEE_PER_SECOND);
    ...
    function test_updateQuoters_doesNotAffectOtherMMQuoter() public {
        ...
        SimpleQuoter newQ1 = deployQuoterProxy(pm, address(hook), mm1, DEFAULT_BASE_FEE, DEFAULT_FEE_PER_SECOND);
        PoolId[] memory pids = new PoolId[](1);
        pids[0] = poolId;
