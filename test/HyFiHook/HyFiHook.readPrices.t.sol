...
contract HyFiHookReadPricesTest is HyFiHookSharedSetup {

    function setUp() public {
        sharedSetup();
    }

    function test_readPrices_returnsStoredValues() public view {
        PoolId[] memory pids = new PoolId[](1);
        pids[0] = poolId;
        HyFiHook.PriceData[] memory out = hook.readPrices(pids);
    ...
    function test_readPrices_unsetPool_returnsZeros() public view {
        PoolId[] memory pids = new PoolId[](1);
    ...
    function test_readPrices_multiplePools() public {
    ...
    function test_readPrices_emptyArray() public view {
