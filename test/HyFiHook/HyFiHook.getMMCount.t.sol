...
contract HyFiHookGetMMCountTest is HyFiHookSharedSetup {
    ...
    function test_getMMCount_afterMultipleRegistrations() public {
        ...
        registerMM(hook, mm2, poolId, ILPQuoter(address(new SimpleQuoter(mm2, DEFAULT_BASE_FEE, DEFAULT_FEE_PER_SECOND))));
        registerMM(hook, mm3, poolId, ILPQuoter(address(new SimpleQuoter(mm3, DEFAULT_BASE_FEE, DEFAULT_FEE_PER_SECOND))));
