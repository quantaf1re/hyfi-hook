...
contract HyFiHookRegisterPoolsTest is HyFiHookSharedSetup {
    ...
    function test_registerPools_RevertWhen_maxLPsReached() public {
        ...
        for (uint i = 0; i < 9; i++) {
            ...
            SimpleQuoter q = new SimpleQuoter(mm, DEFAULT_BASE_FEE, DEFAULT_FEE_PER_SECOND);
        ...
        SimpleQuoter q11 = new SimpleQuoter(mm11, DEFAULT_BASE_FEE, DEFAULT_FEE_PER_SECOND);
